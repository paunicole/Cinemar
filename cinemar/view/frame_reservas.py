...
class ReservaCliente(tk.Frame):
    ...
    def widgets_config(self):
        #Titulo
        self.Cab_principal.config(text='Historial de Reservas', foreground='#FFFFFF', font=('Segoe UI Black', 36), background='red', justify='center')
        #Tabla
        self.Tabla_config()
        #Busqueda
        self.Busq_label.config(text='Buscar reserva por nombre de pelicula', foreground='#FFFFFF', font=('Segoe UI Black', 18), background='black')
