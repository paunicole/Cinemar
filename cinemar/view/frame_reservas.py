...
class ReservaCliente(tk.Frame):
    ...
    def filtrar_reservas(self, peli=None):
        ...
        reservas = self.reserva.obtener_reservas_vigentes(self.bdd, id_usuario)
    ...
    def cancelar_reserva(self):
        ...
        for item_seleccionado in self.tabla.selection():
            ...
            if resultado == "yes":
                self.reserva.eliminar_ticket(self.bdd, id_ticket)
...
class ReservaAdministrador(tk.Frame):
    ...
    def filtrar_tickets(self):
        ...
        for res in reservas:
            self.tabla.insert('', 'end', text=f'{res[0]}', values=(res[1], res[2], res[3], res[4], res[5]))
